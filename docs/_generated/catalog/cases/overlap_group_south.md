---
title: "Overlap Group -- South"
description: "One of three small rasters sharing a CRS and a pixel grid, with deliberate partial overlap and a distinct constant value each. This is the southernmost me…"
---
...
One of three small rasters sharing a CRS and a pixel grid, with deliberate partial overlap and a distinct constant value each. This is the southernmost member, and the only unambiguous band alias. The three exist only as a group: odc.stac.load and stackstac.stack take a *sequence* of Items and their whole reason for existing is what happens across it, which no standalone raster case in this corpus could express.
...
| Property | Value |
|---|---|
| Case ID | `overlap_group_south` |
| Category | raster |
| Format | GeoTIFF |
| CRS | `EPSG:32633` |
| Location | Southern Italy / Sicily (synthetic, UTM 33N) &mdash; 15.00&deg;E, 40.64&deg;N &rarr; 15.01&deg;E, 40.65&deg;N |
| Test tier | unit |
| Size class | tiny |
...
@pytest.mark.geocase_case("overlap_group_south")
def test_overlap_group_south(geocase_case) -> None:
...
| Quantity | Value |
|---|---|
| Mean over valid pixels | `30.0` |
| Mean including NoData | `-39.6458333333` |
| NoData pixels | `1` |
| Bounds (case CRS) | `[500360.0, 4499280.0, 500720.0, 4499640.0]` |
...
- Primary: [`overlap_group_south.tif`](https://github.com/farzinashouri/geocase/raw/main/src/geocase/data/core/raster/overlap_group/overlap_group_south.tif)
...
- [Overlap Group -- Centre](overlap_group_centre.md) -- `overlap_group_centre`
...
<script type="application/ld+json">
{
  ...
  "identifier": "overlap_group_south",
  "url": "https://farzinashouri.github.io/geocase/_generated/catalog/cases/overlap_group_south/",
  "isPartOf": {
    "@type": "DataCatalog",
    "name": "GeoCase",
  ...
  "spatialCoverage": {
    ...
    "geo": {
      "@type": "GeoShape",
      "box": "40.64437 15.004258 40.647613 15.008516"
    },
