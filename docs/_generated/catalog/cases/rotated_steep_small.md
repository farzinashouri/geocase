---
title: "Steeply Rotated DEM (40-Degree Skew)"
description: "A DEM rotated by roughly 40 degrees, against the ~14 degrees of rotated_two_islands. At this angle a consumer assuming a north-up affine misplaces the gri…"
---

<!-- Generated by scripts/generate_catalog_pages.py. Do not edit by hand. -->

# Steeply Rotated DEM (40-Degree Skew)
...
A DEM rotated by roughly 40 degrees, against the ~14 degrees of rotated_two_islands. At this angle a consumer assuming a north-up affine misplaces the grid's far corner by about ten cells rather than one, so the error reads as a wrong answer with a legible direction rather than as a one-pixel edge effect.
...
@pytest.mark.geocase_case("rotated_steep_small")
def test_rotated_steep_small(geocase_case) -> None:
...
Confirm that a consumer honours the affine's skew terms at an angle large enough that ignoring them displaces pixels by several cells, making the magnitude and direction of the error visible in a differential report.
...
- Primary: [`rotated_steep_small.tif`](https://github.com/farzinashouri/geocase/raw/main/src/geocase/data/core/raster/transform_conventions/rotated_steep_small.tif)
...
<script type="application/ld+json">
{
  ...
  "@type": "Dataset",
  "name": "Steeply Rotated DEM (40-Degree Skew)",
  "description": "A DEM rotated by roughly 40 degrees, against the ~14 degrees of rotated_two_islands. At this angle a consumer assuming a north-up affine misplaces the grid's far corner by about ten cells rather than one, so the error reads as a wrong answer with a legible direction rather than as a one-pixel edge effect.",
  "identifier": "rotated_steep_small",
  "url": "https://farzinashouri.github.io/geocase/_generated/catalog/cases/rotated_steep_small/",
  "isPartOf": {
    "@type": "DataCatalog",
    "name": "GeoCase",
  ...
  "spatialCoverage": {
    ...
    "geo": {
      "@type": "GeoShape",
      "box": "37.946263 14.997366 37.950834 15.003139"
    },
