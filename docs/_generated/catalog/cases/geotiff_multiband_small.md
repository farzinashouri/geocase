...
description: "A three-band GeoTIFF with NoData in every band. Exercises band-order preservation and per-band NoData masking on multiband raster reads."
---
...
A three-band GeoTIFF with NoData in every band. Exercises band-order preservation and per-band NoData masking on multiband raster reads.
