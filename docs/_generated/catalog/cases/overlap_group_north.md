---
title: "Overlap Group -- North"
description: "One of three small rasters sharing a CRS and a pixel grid, with deliberate partial overlap and a distinct constant value each. This is the northernmost me…"
---
...
@pytest.mark.geocase_case("overlap_group_north")
def test_overlap_group_north(geocase_case) -> None:
...
- Primary: [`overlap_group_north.tif`](https://github.com/farzinashouri/geocase/raw/main/src/geocase/data/core/raster/overlap_group/overlap_group_north.tif)
...
<script type="application/ld+json">
{
  ...
  "identifier": "overlap_group_north",
  "url": "https://farzinashouri.github.io/geocase/_generated/catalog/cases/overlap_group_north/",
  "isPartOf": {
    "@type": "DataCatalog",
    "name": "GeoCase",
  ...
  "spatialCoverage": {
    ...
    "geo": {
      "@type": "GeoShape",
      "box": "40.647613 15.0 40.650857 15.004258"
    },
