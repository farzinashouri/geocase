...
<div class="gc-badges">
<span class="gc-badge">vector</span><span class="gc-badge">KML</span><span class="gc-badge">MultiPolygon</span><span class="gc-badge">EPSG:4326</span><span class="gc-badge">tiny</span><span class="gc-badge">bundled</span>
</div>
...
### Purpose
Tests MultiPolygon geometry loading from KML format.

### Data
- Geometry: `MULTIPOLYGON (((10 50, 10.5 50, 10.5 50.5, 10 50.5, 10 50)), ((11 50, 11.5 50, 11.5 50.5, 11 50.5, 11 50)))`
- Attributes: `id` = 1, `name` = `multipolygon_kml_baseline`
...
`baseline` `cross_format_canonical` `format_comparison` `kml` `multipolygon` `valid` `vector`
