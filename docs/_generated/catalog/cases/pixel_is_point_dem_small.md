---
title: "Pixel-Is-Point DEM"
description: "Declares AREA_OR_POINT=Point, so the transform's coordinates name pixel centres rather than corners. Byte-identical to pixel_is_area_dem_small apart from…"
---
...
<script type="application/ld+json">
{
  ...
  "@type": "Dataset",
  "name": "Pixel-Is-Point DEM",
  "description": "Declares AREA_OR_POINT=Point, so the transform's coordinates name pixel centres rather than corners. Byte-identical to pixel_is_area_dem_small apart from that one tag, which moves every pixel half a pixel -- a georeferencing error invisible to shape, CRS and checksum checks.",
  "identifier": "pixel_is_point_dem_small",
  "url": "https://farzinashouri.github.io/geocase/_generated/catalog/cases/pixel_is_point_dem_small/",
  "isPartOf": {
    "@type": "DataCatalog",
    "name": "GeoCase",
  ...
  "distribution": [
    {
      ...
      "name": "pixel_is_point_dem_small.tif"
    }
  ],
  "variableMeasured": [
    {
