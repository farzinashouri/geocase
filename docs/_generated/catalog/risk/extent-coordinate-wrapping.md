...
description: "4 GeoCase test cases that exercise the extent/coordinate wrapping failure mode."
---
...
These 4 cases exercise the `extent/coordinate_wrapping` failure mode. Run your function against all of them to check how it behaves.
