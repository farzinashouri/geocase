...
description: "7 GeoCase test cases that exercise the reprojection error failure mode."
---
...
These 7 cases exercise the `reprojection_error` failure mode. Run your function against all of them to check how it behaves.
