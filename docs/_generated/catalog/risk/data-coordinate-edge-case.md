---
title: "Risk type: data/coordinate_edge_case"
description: "2 GeoCase test cases that exercise the data/coordinate edge case failure mode."
---

<!-- Generated by scripts/generate_catalog_pages.py. Do not edit by hand. -->

# Risk type: data/coordinate_edge_case

These 2 cases exercise the `data/coordinate_edge_case` failure mode. Run your function against all of them to check how it behaves.
