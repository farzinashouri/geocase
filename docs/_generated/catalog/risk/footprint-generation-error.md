---
title: "Risk type: footprint/generation_error"
...
# Risk type: footprint/generation_error

These 5 cases exercise the `footprint/generation_error` failure mode. Run your function against all of them to check how it behaves.
