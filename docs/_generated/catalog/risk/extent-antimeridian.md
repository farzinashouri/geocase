...
description: "4 GeoCase test cases that exercise the extent/antimeridian failure mode."
---
...
These 4 cases exercise the `extent/antimeridian` failure mode. Run your function against all of them to check how it behaves.
