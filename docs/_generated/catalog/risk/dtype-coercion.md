---
title: "Risk type: dtype/coercion"
...
# Risk type: dtype/coercion

These 4 cases exercise the `dtype/coercion` failure mode. Run your function against all of them to check how it behaves.
