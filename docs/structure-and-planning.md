 The skeleton is built and the **metadata layer** (Wave 1) is complete.

The next job is to turn the catalog into a **working selection engine** (Wave 2) and then a **runtime loading layer** (Wave 3).
...
See also: [workflow.md](workflow.md) for a detailed status tracker.

Items 1–2 are done. The next priority is item 3.
