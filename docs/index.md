---
description: "GeoCase is a pytest plugin and case catalog: 136 curated geospatial test cases covering NoData, antimeridian crossing, CRS mismatch and axis order."
---
...
- **[Browse all 136 cases](_generated/catalog/index.md)** — the case catalog, filterable by category, risk type, and format
