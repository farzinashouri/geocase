...
To see what ships in the box, [browse all 153 cases](_generated/catalog/index.md).
...
tests and 153 bundled cases. The metadata, catalog, runtime, assertions, loader, and
