...
To see what ships in the box, [browse all 157 cases](_generated/catalog/index.md).
...
tests and 157 bundled cases. The metadata, catalog, runtime, assertions, loader, and
