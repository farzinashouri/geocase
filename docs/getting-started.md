...
To see what ships in the box, [browse all 136 cases](_generated/catalog/index.md).
...
tests and 136 bundled cases. The metadata, catalog, runtime, assertions, loader, and
