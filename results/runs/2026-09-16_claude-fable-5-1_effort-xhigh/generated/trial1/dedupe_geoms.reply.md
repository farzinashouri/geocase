I could not execute anything in this session, since both the shell and scratch-file writes required approval that was not granted, so the module below is unverified by a live run.
