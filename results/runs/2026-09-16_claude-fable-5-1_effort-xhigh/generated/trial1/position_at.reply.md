Here is the module: it brackets `t` between two fixes and interpolates along the WGS84 geodesic with pyproj, so it stays correct across the antimeridian and near the poles.
