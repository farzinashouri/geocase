Here is the module: it reprojects the WGS84 point into the raster's CRS with pyproj, reads a single pixel with rasterio, and returns `None` for out-of-extent, unprojectable, masked, nodata, or NaN pixels.
