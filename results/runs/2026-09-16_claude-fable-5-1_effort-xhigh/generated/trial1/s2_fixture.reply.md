Python execution needs an approval this session can't get, so the module below is unexecuted; I checked the rasterio 1.4 and numpy calls against their documented signatures instead.
