Here is the module. It parses the GeoJSON with the standard library, unwraps longitudes along each line or ring so antimeridian crossings are recognised, and reports a crossing box as RFC 7946 does, with `min_lon > max_lon`.
