Here is the module: it reprojects the WGS84 point into the raster's own CRS with pyproj, looks up the containing pixel, reads just that one cell as a masked array, and returns `None` for out-of-extent, masked/nodata, or NaN cells.
