Writing the module now: geodesic (great-circle) interpolation via pyproj between the bracketing fixes, so it's correct across the antimeridian and near the poles.
