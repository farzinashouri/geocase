Writing the module inline: standard UTM zone math plus the MGRS Norway and Svalbard exceptions, with a `ValueError` for the polar regions that MGRS covers with UPS rather than UTM.
