Writing the module now: single-linkage clustering via a haversine BallTree candidate search, geodesic verification with pyproj when available, and union-find for the chaining.
