Here is the module: single-linkage clustering via union-find over geodesic (WGS84 ellipsoid via pyproj, haversine fallback) pairwise distances, with a latitude-sweep prefilter to skip pairs that cannot be within the threshold.
