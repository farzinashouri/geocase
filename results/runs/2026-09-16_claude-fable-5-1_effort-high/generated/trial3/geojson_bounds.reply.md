Here is the module. It reads every geometry, normalizes longitudes into [-180, 180], and detects antimeridian crossings by segment so the box reflects the true extent (west > east when the data straddles the dateline, per RFC 7946).
