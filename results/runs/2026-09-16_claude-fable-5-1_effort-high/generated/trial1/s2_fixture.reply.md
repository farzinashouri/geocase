The scratch write was declined, so I'll deliver the module directly. The rasterio calls used are standard and unchanged in 1.4, and the numeric encoding follows ESA's baseline 04.00 definition: reflectance = (DN + BOA_ADD_OFFSET) / BOA_QUANTIFICATION_VALUE with offset -1000 and quantification 10000.
