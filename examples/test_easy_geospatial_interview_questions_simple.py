"""Simple-answer edge-case tests for the easy interview utilities."""
...
_SUPPORT_SPEC = importlib.util.spec_from_file_location(
    "_easy_geospatial_interview_test_support_simple",
    _SUPPORT_PATH,
)
...
for _name, _value in vars(_SUPPORT_MODULE).items():
    if _name.startswith("test_") and "_perfect" not in _name:
