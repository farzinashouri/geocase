"""Simple-answer edge-case tests for the easy raster interview utilities."""
...
_SUPPORT_PATH = Path(__file__).with_name("_easy_raster_interview_test_support.py")
_SUPPORT_SPEC = importlib.util.spec_from_file_location(
    "_easy_raster_interview_test_support_simple",
    _SUPPORT_PATH,
)
